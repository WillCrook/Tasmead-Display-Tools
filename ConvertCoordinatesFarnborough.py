...
def write_kml(file_path, coordinates):
    """
...
<Document>
    <name>Adjusted Coordinates</name>
    <description>Generated by Python Script</description>
    <Style id="cyanLine">
        <LineStyle>
...
if __name__ == "__main__":
    try:
        input_dir = "../farnborough-aircraft-route-converter/Input_KML_Files/"
        output_dir = "../farnborough-aircraft-route-converter/Output_KML_Files/"
        os.makedirs(output_dir, exist_ok=True)

        # Location set to Farnborough
        target_lat = 51.279385  
        target_lon = -0.765687  
        target_heading = 251.5  
        ...
        for kml_file_name in os.listdir(input_dir):
            if kml_file_name.endswith(".kml"):
                ...
                output_kml_file = os.path.join(output_dir, f"Farmborough_{kml_file_name}")
                write_kml(output_kml_file, adjusted_waypoints)
